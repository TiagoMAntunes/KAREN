...
class GRU(BaseModel):
    ...
    def add_required_arguments(parser):
        ...
        group.add_argument("--gru-hidden-size", type=int,
                           default=64, help="gru hidden size")
        group.add_argument("--gru-linear-size", type=int,
                           default=8, help="Linear hidden size")
        group.add_argument("--gru-n-layers", type=int,
                           default=2, help="Number of layers in the gru")
        group.add_argument("--gru-dropout-hidden", type=float,
                           default=0.5, help="Dropout between the gru layers")
        group.add_argument("--gru-bidirectional", type=bool,
                           default=True, help="Train Bidirectional gru or gru")
