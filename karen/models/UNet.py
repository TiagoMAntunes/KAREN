...
class UNet(BaseModel):
    ...
    def add_required_arguments(parser):
        ...
        group.add_argument("--unet-depth", type=int, default=3, help="Depth of UNet")
        group.add_argument(
            "--unet-channel-jump",
            type=int,
            default=32,
        ...
        group.add_argument("--unet-encoding-ks", type=int, default=3, help="Encoding kernel size")
        group.add_argument("--unet-decoding-ks", type=int, default=3, help="Decoding kernel size")
        group.add_argument(
            "--unet-use-linear",
            action="store_true",
